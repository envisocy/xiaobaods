...
- 01:2017-04-10
    ...
    - ver_20 06-06 _a，添加标题筛选功能
    - ver_22 06-08 -ws，再次重做，采用复合算法，提高命中率
    - ver_23 06-19 _e，针对生E经的属性查询数据原版输出直方图
    - ver_24 06-19 _e，添加针对全表输出variable的"all"属性和针对类目的"成交量分布"
    - ver_25 06-30 _ef，针对_e的衍生全局分析功能
...
### e
针对生E经的属性查询数据原版输出直方图
> from:"shengejing_category"
##### version:
- e:2017-06-19
    - ver_23 新建
    - ver_24 针对全变量输出和子行业输出做了匹配
- et:2017-06-30
    - ver_25 针对生e经数据的全局分析功能